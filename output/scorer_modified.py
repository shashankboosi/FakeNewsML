...
Usage: python scorer_modified.py <true_file> <predictions_file>

  true_file - CSV file with true stance labels
  predictions_file - CSV file with predicted stance labels
...
def report_score(true_set, test_set):
	try:
		gold_labels = load_dataset(true_set)
		test_labels = load_dataset(test_set)
